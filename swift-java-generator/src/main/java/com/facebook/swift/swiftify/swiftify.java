...
public class swiftify
{
    ...
    @Parameter(description = "Add TExcept to throws clause of all Thrift service methods",
    names = { "-x", "--throws-thrift-exception"})
    public boolean declareThriftMethodThrowsThriftException = false;
            ...
            throws IOException
    {
        ...
        SwiftClassGenerator generator = new SwiftClassGenerator(generatedOutputRoot.toString(),
                                                                declareThriftMethodThrowsThriftException);
