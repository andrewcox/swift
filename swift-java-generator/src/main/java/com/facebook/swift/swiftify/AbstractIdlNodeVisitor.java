...
public abstract class AbstractIdlNodeVisitor
{
            ...
            throws IOException
    {
        if (node instanceof BaseType) {
            ...
            generateStruct((Struct) node);
        } else if (node instanceof ThriftException) {
            generateThriftException((ThriftException) node);
